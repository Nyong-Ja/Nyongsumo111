...
const EQUIPMENT_DATA = [
    ...
    },
    {
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">2. 사용법 & 실전 메커니즘</div>
            <p class="dict-text">DOTS 증거 유령은 짧은 DOTS 상태에서 적외선 격자를 통과하는 모습이 보입니다. T2·T3는 설치형이며 T3는 스캔을 멈추면 소음 없이 고정할 수 있습니다. 고료는 플레이어가 현재 방에 없을 때 비디오 카메라를 통해 DOTS를 확인하는 것이 핵심입니다.</p>
            <div class="dict-section-title">3. 실전 판별 포인트</div>
            <p class="dict-text">• <strong>티어 차이는 단순한 상위호환이 아닙니다.</strong> 같은 장비라도 전자기기 여부, 감지 방식, 설치 방식이 달라 실제 조사법이 달라질 수 있습니다.<br>• 수치가 적용되는 범위는 장비의 <strong>티어·유령 상태·난이도</strong>에 따라 달라질 수 있으므로, 특정 유령의 특수 능력과 함께 확인하세요.</p>
        `
    },
    ...
    },
    {
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">2. 사용법 & 실전 메커니즘</div>
            <p class="dict-text">주로 고스트 오브와 DOTS 확인에 사용합니다. T2·T3는 화면에서 촬영 영역을 확인하기 쉽습니다. 삼각대에 장착하면 트럭에서 카메라 화면을 볼 수 있으며, 사냥 중 전자기기이므로 유령의 전자기기 감지 범위에 주의하세요.</p>
            <div class="dict-section-title">3. 실전 판별 포인트</div>
            <p class="dict-text">• <strong>티어 차이는 단순한 상위호환이 아닙니다.</strong> 같은 장비라도 전자기기 여부, 감지 방식, 설치 방식이 달라 실제 조사법이 달라질 수 있습니다.<br>• 수치가 적용되는 범위는 장비의 <strong>티어·유령 상태·난이도</strong>에 따라 달라질 수 있으므로, 특정 유령의 특수 능력과 함께 확인하세요.</p>
        `
    },
    ...
    },
    {
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">2. 사용법 & 실전 메커니즘</div>
            <p class="dict-text">유령의 초자연적 소리, 이벤트, 스피릿 박스 응답, 라이팅, EMF 5 등의 소리를 녹음할 수 있습니다. 계약당 최대 3개의 오디오 클립을 저장할 수 있습니다. 모로이는 성공적인 녹음으로 플레이어를 저주할 수 있고, 밴시는 고유 비명을 낼 확률이 있습니다.</p>
            <div class="dict-section-title">3. 실전 판별 포인트</div>
            <p class="dict-text">• <strong>티어 차이는 단순한 상위호환이 아닙니다.</strong> 같은 장비라도 전자기기 여부, 감지 방식, 설치 방식이 달라 실제 조사법이 달라질 수 있습니다.<br>• 수치가 적용되는 범위는 장비의 <strong>티어·유령 상태·난이도</strong>에 따라 달라질 수 있으므로, 특정 유령의 특수 능력과 함께 확인하세요.</p>
        `
    },
