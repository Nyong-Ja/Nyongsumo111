const GHOST_DATA = [
    {
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>향초 타이머 감별법:</strong> 정신력을 낮춘 상태에서 향초를 사용한 뒤 사냥이 다시 가능해지는 시간을 비교하면 스피릿 판별에 도움이 됩니다. 스피릿은 일반 유령보다 긴 180초의 향초 사냥 봉인 시간을 가집니다.<br>
                • <strong>소거법 활용:</strong> 특수 속도 변화나 시각적 기믹이 전혀 없는 가장 표준적인 유령이므로, 다른 특수 유령들의 가능성을 모두 배제한 뒤 향초 타이머로 최종 확정짓는 것이 좋습니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>향초 사냥 봉인:</strong> 일반 유령의 90초가 아닌 <strong>180초</strong>입니다.<br>
• <strong>사냥:</strong> 기본 임계값 <strong>50%</strong>, 기본 속도 <strong>1.7 m/s</strong>, 일반적인 시야 가속 적용.<br>
• <strong>실전 테스트:</strong> 향초 후 3분 이내에 다시 사냥을 시도한다면 스피릿이 아닐 가능성이 높습니다.</p>
        `
    },
    {
        name: "레이스",
        ...
        tip: `<strong>1. 사냥 및 특수 이동 메커니즘</strong><br>
              ...
              • <strong>플레이어 순간이동 능력:</strong> 사냥 중이 아닐 때 무작위 플레이어 위치로 순간이동(Teleport)하며, 순간이동이 발생한 <strong>도착 지점에서 EMF 2 또는 EMF 5</strong>가 발생합니다.`,
        huntSanity: "50%",
        specialTrait: "소금을 밟지 않으며, 비사냥 중 플레이어 근처로 순간이동하는 능력이 있습니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>플레이어 순간이동 능력:</strong> 사냥 중이 아닐 때, 맵 내 무작위 플레이어 한 명의 바로 옆 위치로 순간이동(Teleport)을 수행할 수 있습니다. 순간이동 후 <strong>도착 지점에서 EMF 2 또는 EMF 5</strong> 신호가 발생합니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • EMF 5단계 (EMF Level 5)<br>
            ...
            <p class="dict-text">
                ...
                • <strong>약점 (Weakness):</strong> 소금에 반응하지 않는 특성이 있어, 다른 조건과 함께 사용하면 정체를 강하게 좁힐 수 있습니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
                • <strong>소금 테스트:</strong> 고스트 룸이나 동선에 소금을 깔아두고 유령을 유도했을 때 소금을 밟지 않는다면 레이스를 강하게 의심할 수 있습니다.<br>
                • <strong>기습 EMF 반응:</strong> 고스트 룸과 멀리 떨어진 방에 서 있는데 갑자기 내 발밑에서 EMF 2 또는 EMF 5가 울린다면 레이스가 나에게 순간이동을 한 것입니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>소금:</strong> 소금 더미를 밟아도 발자국을 남기지 않습니다.<br>
• <strong>순간이동:</strong> 비사냥 중 플레이어 위치로 순간이동할 수 있으며, <strong>도착 지점</strong>에서 EMF 반응이 발생합니다.<br>
• <strong>주의:</strong> 레이스가 벽이나 바닥을 투과해서 이동하는 유령이라는 뜻은 아닙니다.</p>
        `
    },
    {
        name: "팬텀",
        ...
        tip: `<strong>1. 시각적 특성 및 사냥 메커니즘</strong><br>
              • <strong>기본 사냥 조건:</strong> 평균 정신력이 <strong>50% 이하</strong>일 때 사냥을 시작합니다.<br>
              • <strong>직시 정신력 차감:</strong> 실체화된 팬텀을 바라볼 경우 <strong>초당 약 0.5%의 정신력이 감소</strong>합니다.<br>
              • <strong>사진 촬영 시 소멸:</strong> 사진을 찍으면 <strong>모습이 즉시 사라지며</strong>(사진 판정 정상), 사냥 시 <strong>투명하게 숨는 깜빡임 주기(1~2초)가 매우 깁니다.</strong>`,
        huntSanity: "50%",
        specialTrait: "직시 시 초당 정신력 약 0.5% 차감, 사진 촬영 시 모습 소멸, 사냥 중 투명 시간이 긺.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>기본 사냥 조건:</strong> 평균 정신력이 <strong>50% 이하</strong>일 때 사냥을 시작합니다.<br>
                • <strong>직시 정신력 차감:</strong> 실체화된 팬텀을 조준선에 두고 바라볼 경우 <strong>초당 약 0.5%의 정신력이 감소</strong>합니다.<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>직시 정신력 감소:</strong> 유령 이벤트/사냥 중 10m 이내에서 시야가 확보되면 <strong>초당 0.5%</strong>가 추가로 감소합니다.<br>
• <strong>순간이동:</strong> 무작위 플레이어 위치 <strong>5m 이내</strong>로 이동하는 능력이 있으며, 도착 지점에서 EMF 2가 발생합니다.<br>
• <strong>사냥 깜빡임:</strong> 일반 유령보다 훨씬 오래 보이지 않으며, 총 깜빡임 주기는 약 <strong>1~2초</strong>입니다.<br>
• <strong>사진:</strong> 성공적으로 촬영하면 해당 이벤트/사냥에서 유령의 실체가 사라집니다.</p>
        `
    },
    {
        name: "폴터가이스트",
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>정신력 폭발 차감:</strong> 특수 능력으로 물건을 던질 때, <strong>주변 플레이어의 정신력이 감소</strong>합니다.<br>
            ...
            <p class="dict-text">
                ...
                • <strong>약점 (Weakness):</strong> 물건이 없는 방에서는 눈에 보이는 물건 투척이 발생하지 않아 특수 능력을 확인하기 어렵습니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>다중 투척:</strong> 주변 물건을 한꺼번에 던지는 특수 능력을 사용할 수 있습니다. <strong>주변 물건이 없어도 능력 자체는 발동 가능</strong>합니다.<br>
• <strong>능력 정신력 감소:</strong> 같은 방의 플레이어는 던져진 물건 <strong>1개당 2%</strong>씩 정신력이 감소합니다.<br>
• <strong>사냥 중 투척:</strong> 주변에 던질 물건이 있다면 <strong>0.5초마다 100% 확률</strong>로 투척합니다.<br>
• <strong>투척 거리:</strong> 일반 유령보다 훨씬 강한 힘으로 물건을 던질 수 있습니다.</p>
        `
    },
    {
        name: "밴시",
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>타겟 우선 추적:</strong> 조사 구역 안의 타겟을 추적할 때는 타겟이 아닌 플레이어를 우선적으로 추적하지 않습니다. 타겟이 조사 구역 밖에 있으면 일반 유령처럼 다른 플레이어를 추적할 수 있습니다.<br>
                • <strong>타겟 부재 시 룰:</strong> 타겟이 조사 구역 밖에 있다면 사냥 중 다른 플레이어를 추적할 수 있습니다.<br>
            ...
            <p class="dict-text">
                ...
                • <strong>타겟 확인 테스트:</strong> 타겟으로 지정된 플레이어와 비타겟 플레이어에 대한 추적 차이를 관찰하면 밴시 판별에 도움이 됩니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>타깃:</strong> 계약 시작 시 한 명을 타깃으로 정하고, 타깃이 건물 안에 있다면 사냥 중 다른 플레이어를 무시합니다.<br>
• <strong>타깃 정신력:</strong> 사냥 가능 여부는 팀 평균 정신력이 아니라 <strong>타깃 개인의 정신력</strong>을 기준으로 판단합니다.<br>
• <strong>노래 이벤트:</strong> 일반 유령보다 훨씬 높은 <strong>46.67%</strong> 확률로 노래 이벤트를 선택합니다.<br>
• <strong>노래 이벤트 접촉:</strong> 타깃이 노래 이벤트에서 유령과 접촉해 이벤트를 끝내면 <strong>15%</strong> 정신력을 잃습니다.<br>
• <strong>지향성 마이크/녹음기:</strong> 특수 비명은 약 <strong>33%</strong> 확률입니다.</p>
        `
    },
    {
        name: "다얀",
        ...
        sanity: "기본 50% / 정지 플레이어 근처 45% / 이동 플레이어 근처 65%",
        speed: "기본 1.7 m/s / 정지 플레이어 근처 1.2 m/s / 이동 플레이어 근처 2.25 m/s",
        ...
        tip: `<strong>1. 사냥 및 움직임 감지 메커니즘</strong><br>
              ...
              • <strong>이동 플레이어 조건 (2.25 m/s):</strong> 10m 내의 플레이어가 걷거나 뛰면 시야 여부와 무관하게 <strong>2.25 m/s</strong>로 이동합니다.<br>
              • <strong>정지 플레이어 조건 (1.2 m/s):</strong> 10m 이내의 플레이어가 가만히 멈춰 있으면 <strong>1.2 m/s</strong>로 느려집니다. (시야 가속 없음)`,
        huntSanity: "50%",
        specialTrait: "10m 이내 플레이어의 이동 여부에 따라 속도가 변화하며, 정지/이동 상태에 따라 특수 사냥 조건이 적용됩니다.",
        forcedEvidence: "없음",
        hasAccel: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>이동 플레이어 조건 (2.25 m/s):</strong> 10m 이내의 플레이어가 이동 중일 경우 <strong>2.25 m/s</strong>로 이동합니다.<br>
                • <strong>정지 플레이어 조건 (1.2 m/s):</strong> 10m 이내의 플레이어가 가만히 있으면 <strong>1.2 m/s</strong>로 느려집니다.<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>10m 규칙:</strong> 가장 가까운 플레이어가 10m 이내에 있을 때 상태가 결정됩니다.<br>
• <strong>플레이어 이동 중:</strong> 사냥 임계값 <strong>65%</strong>, 속도 <strong>2.25 m/s</strong>.<br>
• <strong>플레이어 정지:</strong> 사냥 임계값 <strong>45%</strong>, 속도 <strong>1.2 m/s</strong>.<br>
• <strong>10m 밖:</strong> 일반 유령처럼 <strong>50%</strong> 임계값과 기본 속도를 사용합니다.<br>
• <strong>성별:</strong> 항상 여성 이름/모델을 사용합니다.</p>
        `
    },
    {
        name: "데일드가스트",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>사냥 시작 속도:</strong> <strong>3.0 m/s</strong>.<br>
• <strong>최저 속도:</strong> <strong>0.4 m/s</strong>까지 내려갈 수 있습니다.<br>
• <strong>시야 가속:</strong> 일반적인 LOS 가속을 사용하지 않습니다.<br>
• <strong>판별:</strong> 사냥마다 속도가 크게 달라지는지 확인하고, 다른 유령처럼 시야를 오래 유지했다고 가속되는지 여부를 함께 확인하는 것이 좋습니다.</p>
        `
    },
    {
        name: "데오겐",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>사냥 임계값:</strong> <strong>40%</strong>.<br>
• <strong>속도:</strong> 대상과 멀리 떨어져 있을 때 최대 <strong>3.0 m/s</strong>, <strong>2.5m 이내</strong>에서는 <strong>0.4 m/s</strong>까지 급격히 느려집니다.<br>
• <strong>은신:</strong> 항상 플레이어의 위치를 알고 있어 일반적인 숨기 테스트가 통하지 않습니다.<br>
• <strong>스피릿 박스:</strong> 1m 이내에서 질문할 경우 특수한 거친 숨소리 응답이 나올 수 있습니다.</p>
        `
    },
    {
        name: "데몬",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>일반 사냥 임계값:</strong> <strong>70%</strong>.<br>
• <strong>특수 사냥:</strong> 능력이 발동하면 정신력과 관계없이 사냥할 수 있습니다.<br>
• <strong>사냥 쿨다운:</strong> 최소 <strong>20초</strong>로 일반적인 25초보다 짧습니다.<br>
• <strong>향초:</strong> 사냥 방지 시간이 <strong>60초</strong>로 일반 유령의 90초보다 짧습니다.<br>
• <strong>십자가:</strong> 유효 범위가 일반보다 <strong>50% 넓습니다</strong>. T1/T2/T3은 각각 4.5m/6m/7.5m입니다.</p>
        `
    },
    {
        name: "갈루",
        ...
        sanity: "50%",
        speed: "기본 1.7 m/s / 분노 상태 1.96 m/s / 약화 상태 1.36 m/s",
        ytUrl: "https://www.youtube.com/results?search_query=파스모포비아+갈루+공략",
        tip: `<strong>1. 3단계 상태 변환 메커니즘</strong><br>
              • <strong>상태 변화:</strong> 갈루는 일반, 분노, 약화 상태를 가지며 상태에 따라 속도와 방어 장비 상호작용이 달라집니다. 속도는 각각 <strong>1.7 / 1.96 / 1.36 m/s</strong>입니다.<br>
        ...
        huntSanity: "50%",
        specialTrait: "일반 1.7m/s / 분노 1.96m/s / 약화 1.36m/s의 3단계 상태 변화. 상태에 따라 방어 장비 상호작용이 달라집니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: true,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>3단계 상태:</strong> 갈루는 일반, 분노, 약화 상태를 가지며 상태에 따라 사냥 속도와 방어 장비 상호작용이 달라집니다. 일반 1.7m/s, 분노 1.96m/s, 약화 1.36m/s입니다.<br>
            ...
            <div class="dict-section-title">3. 강점 및 약점 (Strengths & Weaknesses)</div>
            <p class="dict-text">
                • <strong>강점 (Strength):</strong> 방어 장비에 의해 상태가 변화하면 사냥 속도와 행동이 크게 달라집니다.<br>
                • <strong>약점 (Weakness):</strong> 약화 상태에서는 기본 상태보다 느린 속도로 사냥합니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>일반 상태:</strong> 사냥 50% / 속도 <strong>1.7 m/s</strong> / 십자가 범위 기본 / 향초 5초.<br>
• <strong>분노 상태:</strong> 사냥 <strong>60%</strong> / 속도 <strong>1.955 m/s</strong> / 십자가 범위 <strong>2m 감소</strong> / 향초 <strong>4초</strong>.<br>
• <strong>약화 상태:</strong> 사냥 <strong>40%</strong> / 속도 <strong>1.36 m/s</strong> / 십자가 범위 <strong>1m 증가</strong> / 향초 <strong>6초</strong>.<br>
• <strong>소금:</strong> 분노 상태에서는 소금 더미를 건드리지 않습니다.<br>
• <strong>핵심:</strong> 네가 말한 것처럼 <strong>약화 상태에서는 십자가 유효 범위가 1m 늘어납니다.</strong></p>
        `
    },
    {
        name: "고료",
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>부재 조건:</strong> 고료의 DOTS는 같은 방에 플레이어가 없을 때 관찰할 수 있으며, 플레이어가 같은 방에 있으면 DOTS 발현을 확인하기 어렵습니다.<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>DOTS:</strong> 플레이어가 현재 방에 없을 때만 DOTS 상태에 들어갈 수 있으며, 실루엣은 <strong>비디오 카메라로만</strong> 볼 수 있습니다.<br>
• <strong>DOTS 진입 확률:</strong> 로밍 상태에서 DOTS 상태로 들어갈 확률이 일반 유령의 1/3보다 높은 <strong>2/3</strong>입니다.<br>
• <strong>고스트 룸:</strong> 선호 방을 변경하지 않으며 장거리 로밍을 하지 않습니다.<br>
• <strong>주의:</strong> 이벤트가 다른 장소에서 발생했다고 해서 고료를 바로 배제할 수는 없습니다.</p>
        `
    },
    {
        name: "한투",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>온도별 속도:</strong> 15°C 초과 <strong>1.4 m/s</strong> → 12~15°C 1.75 → 9~12°C 2.1 → 6~9°C 2.3 → 3~6°C 2.4 → 0~3°C 2.5 → 0°C 미만 <strong>2.7 m/s</strong>.<br>
• <strong>시야 가속:</strong> 일반적인 LOS 가속이 없습니다.<br>
• <strong>두꺼비집:</strong> 직접 켤 수 없으며, 다른 유령보다 두꺼비집을 끄는 성향이 강합니다.<br>
• <strong>사냥 입김:</strong> 두꺼비집이 꺼져 있으면 사냥 중 얼음 입김이 나타납니다.</p>
        `
    },
    {
        name: "진",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>특수 속도:</strong> 두꺼비집이 켜져 있고, 플레이어를 시야에 두며, <strong>3m보다 멀리</strong> 떨어져 있으면 <strong>2.5 m/s</strong>로 고정됩니다.<br>
• <strong>정신력 능력:</strong> 두꺼비집이 켜져 있을 때 같은 방 또는 <strong>3m 이내</strong> 플레이어에게 <strong>25%</strong> 정신력 감소를 줄 수 있으며, 두꺼비집에서 EMF가 발생합니다.<br>
• <strong>두꺼비집:</strong> 직접 끌 수는 없지만 과부하로 인해 꺼질 수는 있습니다.</p>
        `
    },
    {
        name: "메어",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>불 꺼짐:</strong> 현재 방의 불이 꺼져 있으면 사냥 임계값 <strong>60%</strong>.<br>
• <strong>불 켜짐:</strong> 현재 방의 불이 켜져 있으면 <strong>40%</strong>로 낮아집니다.<br>
• <strong>범위:</strong> 이 판정은 두꺼비집이 꺼져 있거나 고장난 경우에도 적용됩니다.<br>
• <strong>즉시 소등:</strong> 플레이어가 메어 근처 4m 이내의 불을 켜면 약 <strong>1/7</strong> 확률로 최대 1초 내 다시 끌 수 있습니다.<br>
• <strong>주의:</strong> 손전등이나 불빛 아이템은 사냥 임계값을 바꾸지 않습니다.</p>
        `
    },
    {
        name: "마일링",
        ...
        huntSanity: "50%",
        specialTrait: "발소리 가청 범위가 약 12m로 짧고, 전자기기 교란 범위는 약 10m입니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>기본 사냥 조건:</strong> 평균 정신력 <strong>50% 이하</strong>에서 사냥을 시작합니다.<br>
                • <strong>사냥 발소리 가청 범위 차단:</strong> 일반 유령보다 짧은 <strong>약 12m</strong> 거리에서 발소리를 들을 수 있습니다. 전자기기 교란 범위는 별도로 <strong>약 10m</strong>입니다.<br>
            ...
            <p class="dict-text">
                ...
                • <strong>약점 (Weakness):</strong> 전자기기 교란 거리(약 10m)와 발소리 가청 거리(약 12m)의 차이를 이용하면 판별에 도움이 됩니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
                • <strong>전자기기 & 발소리 테스트:</strong> 사냥 중 약 10~12m 구간에서 전자기기 교란은 발생하지만 발소리는 아직 들리지 않거나, 두 현상의 거리가 일반 유령보다 짧게 느껴지는지 관찰합니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>발소리/음성:</strong> 사냥 중 들을 수 있는 범위가 일반적인 20m보다 짧은 <strong>12m</strong>입니다.<br>
• <strong>전자기기 교란:</strong> 일반적인 <strong>10m</strong> 범위와 별개입니다.<br>
• <strong>실전 테스트:</strong> 전자기기가 교란되기 시작한 뒤 발소리가 조금 늦게 들리는지를 확인하면 마일링 판별에 도움이 됩니다.</p>
        `
    },
    {
        name: "모로이",
        ...
        tip: `<strong>1. 저주 시스템 & 정신력 비례 가속 메커니즘</strong><br>
              ...
              • <strong>시야 가속 중첩 & 향초 7초:</strong> 시야 가속이 별도로 중첩될 수 있으며, 사냥 중 정화향초에 맞으면 <strong>7초 동안 시야가 차단</strong>됩니다. 또한 Spirit Box뿐 아니라 Parabolic Microphone과 Sound Recorder를 통해 저주가 걸릴 수 있습니다.`,
        huntSanity: "50%",
        specialTrait: "저주로 정신력 감소가 빨라지고, 정신력에 따라 사냥 속도가 증가합니다. 사냥 중 정화향초 실명은 7초입니다.",
        forcedEvidence: "스피릿 박스",
        hasAccel: true,
        hasSpecialSpeed: true,
        hasForcedEv: true,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>저주 부여 (Curse):</strong> 모로이의 저주에 걸린 플레이어는 정신력 감소가 크게 빨라집니다. 저주는 <strong>Spirit Box, Parabolic Microphone, Sound Recorder</strong>를 통해 발생할 수 있습니다.<br>
                ...
                • <strong>정화향초 패시브 약점:</strong> 사냥 중 향초를 맞으면 일반 유령보다 긴 <strong>7초 동안 시야가 차단</strong>됩니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • 스피릿 박스 (Spirit Box) - <strong>[고정 증거]</strong><br>
            ...
            <p class="dict-text">
                ...
                • <strong>약점 (Weakness):</strong> 정화향초에 피격되면 <strong>7초 동안 시야가 차단</strong>되어 도망칠 시간을 확보할 수 있습니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
                • <strong>스피릿 박스 후 양약 복용:</strong> 스피릿 박스로 응답을 들은 즉시 저주를 풀기 위해 정신력 약을 복용해야 합니다.<br>
                • <strong>정화향초 타이머:</strong> 사냥 중 향초를 사용했을 때 모로이가 다른 유령보다 긴 <strong>7초 동안 실명</strong>하는지 관찰하면 판별에 도움이 됩니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>사냥 임계값:</strong> <strong>50%</strong>.<br>
• <strong>속도:</strong> 평균 정신력 45% 이상에서는 <strong>1.5 m/s</strong>, 0~5%에서는 최대 <strong>2.25 m/s</strong>까지 증가합니다.<br>
• <strong>속도 증가:</strong> 평균 정신력이 내려갈수록 약 5% 단위로 속도가 단계적으로 상승합니다.<br>
• <strong>저주:</strong> 스피릿 박스 응답, 지향성 마이크의 초자연적 소리, 소리 녹음기 녹음으로 저주가 걸릴 수 있으며, 저주받은 플레이어의 <strong>수동 정신력 감소가 2배</strong>가 됩니다.<br>
• <strong>향초:</strong> 사냥 중 실명 시간이 <strong>7초</strong>입니다.</p>
        `
    },
    {
        name: "오바케",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>UV 흔적:</strong> 유효 표면을 만졌을 때 일반적으로 <strong>75%</strong> 확률로 흔적을 남깁니다.<br>
• <strong>특수 손자국:</strong> 흔적을 남길 경우 약 <strong>16.7%</strong> 확률로 6손가락 손자국, 스위치/램프의 2개 지문, 키보드/Prison 셀문의 5개 지문 등이 나타납니다.<br>
• <strong>지문 소멸:</strong> 기존 지문의 남은 시간을 절반으로 줄이는 능력이 있습니다.<br>
• <strong>사냥 변신:</strong> 특정 깜빡임에서 다른 같은 성별 모델로 변신합니다. 변신은 사냥 중 최소 한 번 발생하도록 설계되어 있습니다.</p>
        `
    },
    {
        name: "오밤보",
        ...
        sanity: "차분 10% / 공격적 65%",
        speed: "차분 상태 1.445 m/s / 공격적 상태 1.955 m/s",
        ytUrl: "https://www.youtube.com/results?search_query=파스모포비아+오밤보+공략",
        tip: `<strong>1. 주기적 성격 및 속도 변환 메커니즘</strong><br>
              • <strong>상태 변화:</strong> 오밤보는 차분한 상태와 공격적인 상태를 오가며, 상태에 따라 사냥 정신력과 속도가 달라집니다. 상태는 사냥 중에도 변할 수 있습니다.<br>
              • <strong>공격적 상태 (1.955 m/s):</strong> 공격적 상태에서는 <strong>1.955 m/s</strong>로 이동하며 사냥 정신력 기준이 <strong>65%</strong>입니다.<br>
              • <strong>차분함 상태 (1.445 m/s):</strong> 차분한 상태에서는 <strong>1.445 m/s</strong>로 이동하며 사냥 정신력 기준이 <strong>10%</strong>입니다.`,
        huntSanity: "50%",
        specialTrait: "차분 10% / 공격적 65%의 사냥 조건과 1.445 / 1.955m/s의 상태별 속도. 공격적 상태에서 시작한 사냥은 20% 짧습니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: true,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>상태 변화 (State Cycle):</strong> 차분한 상태와 공격적인 상태를 오가며, 상태는 <strong>사냥 중에도 변할 수 있습니다.</strong><br>
                • <strong>공격적 상태 (1.955 m/s):</strong> 공격적 상태에서는 <strong>1.955 m/s</strong>로 이동하며 사냥 정신력 기준은 <strong>65%</strong>입니다.<br>
                • <strong>차분함 상태 (1.445 m/s):</strong> 차분한 상태에서는 <strong>1.445 m/s</strong>로 이동하며 사냥 정신력 기준은 <strong>10%</strong>입니다.<br>
                • <strong>공격적 상태의 사냥 지속시간:</strong> 공격적 상태에서 시작한 사냥은 일반적인 경우보다 <strong>20% 짧은 지속시간</strong>을 가집니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • 자외선 / 손자국 (Ultraviolet)<br>
            ...
            <div class="dict-section-title">3. 강점 및 약점 (Strengths & Weaknesses)</div>
            <p class="dict-text">
                • <strong>강점 (Strength):</strong> 공격적 상태에서는 높은 사냥 정신력과 빠른 속도로 압박합니다.<br>
                • <strong>약점 (Weakness):</strong> 차분한 상태에서는 사냥 정신력 기준과 속도가 크게 낮아집니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
                • <strong>상태 변화 관찰:</strong> 사냥마다 속도와 사냥 정신력 조건이 크게 달라지는지 확인하면 오밤보 판별에 도움이 됩니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>차분 상태:</strong> 사냥 <strong>10%</strong> / 속도 <strong>1.445 m/s</strong>.<br>
• <strong>공격적 상태:</strong> 사냥 <strong>65%</strong> / 속도 <strong>1.955 m/s</strong>.<br>
• <strong>상태 전환:</strong> 입구 문을 처음 연 뒤 약 <strong>1분</strong> 후 첫 전환이 발생하고, 이후 <strong>2분 간격</strong>으로 전환됩니다. 사냥 중에도 전환될 수 있습니다.<br>
• <strong>사냥 시간:</strong> 공격적 상태에서 시작한 사냥은 <strong>20% 짧습니다.</strong></p>
        `
    },
    {
        name: "오니",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>활동:</strong> 유령과 같은 방 또는 <strong>6m 이내</strong>에 플레이어가 있으면 활동 수치가 <strong>30</strong> 증가합니다.<br>
• <strong>이벤트:</strong> 안개 형태 이벤트를 수행하지 않으며, 추격 이벤트 확률이 일반적인 20%보다 높은 <strong>40%</strong>입니다.<br>
• <strong>접촉 정신력:</strong> 이벤트 중 플레이어와 충돌하면 일반적인 10%가 아니라 <strong>20%</strong>가 감소합니다.<br>
• <strong>사냥 깜빡임:</strong> 일반 유령보다 실체가 보이는 시간이 긴 편이라 깜빡임이 상대적으로 잘 보입니다.</p>
        `
    },
    {
        name: "원령",
        ...
        tip: `<strong>1. 불빛 방어 & 3번째 불 끄기 강제 사냥</strong><br>
              ...
              • <strong>3회 불꽃 카운터:</strong> 원령이 불꽃을 3회 이상 끄면 이후 조건에 따라 정신력과 무관하게 사냥을 시도할 수 있습니다.<br>
              • <strong>어둠 속 사냥 정신력 (60%):</strong> 불빛이 없는 어둠 속에서는 정신력 <strong>60% 이하</strong>부터 사냥이 가능합니다.`,
        huntSanity: "60%",
        specialTrait: "불꽃과 사냥이 특별한 상호작용을 가지며, 3회 이상 불꽃을 끈 뒤 조건이 맞으면 정신력과 관계없이 사냥을 시도합니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>불꽃과 사냥:</strong> 원령의 불꽃은 사냥 시도와 특별한 상호작용을 하며, 불꽃이 남아 있으면 사냥 시도를 막는 데 사용됩니다.<br>
                • <strong>불꽃 카운터:</strong> 원령이 불꽃을 끄면 카운터가 누적됩니다. <strong>3회 이상</strong> 누적된 뒤 조건이 맞으면 정신력과 관계없이 사냥을 시도할 수 있으며, 세 번째 불이 꺼지는 순간마다 무조건 즉시 사냥하는 것은 아닙니다.<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>기본 사냥 임계값:</strong> <strong>60%</strong>.<br>
• <strong>불꽃 근처:</strong> 불꽃 4m 이내에서는 임계값이 <strong>40%</strong>로 낮아집니다.<br>
• <strong>불꽃 3회:</strong> 불꽃을 3번 끈 카운터가 조건을 충족하면 정신력과 관계없이 특수 사냥을 <strong>시도</strong>합니다. 세 번째 소등 직후 반드시 즉시 시작되는 것은 아닙니다.<br>
• <strong>불꽃 우선:</strong> 사냥 시도 지점에 불꽃이 있으면 불꽃을 먼저 끄고 사냥이 실패할 수 있습니다.<br>
• <strong>추가:</strong> 사냥 중이나 향초 정화 효과 중 3번째 소등이 발생하면 특수 사냥 카운터가 취소될 수 있습니다.</p>
        `
    },
    {
        name: "라이주",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>전자기기 근처 사냥:</strong> 지도 크기에 따라 소형 <strong>6m</strong> / 중형 <strong>8m</strong> / 대형 <strong>10m</strong> 이내의 활성 전자기기가 있으면 <strong>2.5 m/s</strong>로 이동하고 사냥 임계값이 <strong>65%</strong>가 됩니다.<br>
• <strong>전자기기 교란:</strong> 이벤트/사냥 중 교란 범위가 일반 10m보다 넓은 <strong>15m</strong>입니다.<br>
• <strong>주의:</strong> 버려진 카메라나 일부 센서 등은 라이주의 속도/사냥 임계값 계산에 포함되지 않습니다.</p>
        `
    },
    {
        name: "레버넌트",
        ...
        tip: `<strong>1. 시야 감지 극단적 속도 변화</strong><br>
              ...
              • <strong>마지막 위치까지 가속 유지:</strong> 플레이어를 감지해 3.0m/s가 된 레버넌트는 시야가 끊겨도 <strong>마지막으로 확인한 위치까지 빠른 속도를 유지</strong>한 뒤 감속합니다.`,
        huntSanity: "50%",
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>마지막 위치까지 가속 유지:</strong> 플레이어가 코너 뒤나 은신처로 숨어 시야가 사라져도 레버넌트는 <strong>마지막으로 확인한 위치까지 3.0m/s를 유지</strong>한 뒤 느려집니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • 고스트 오브 (Ghost Orb)<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>탐지 전:</strong> <strong>1.0 m/s</strong>.<br>
• <strong>플레이어 탐지 후:</strong> <strong>3.0 m/s</strong>로 상승합니다.<br>
• <strong>탐지 상실 후:</strong> 즉시 1.0 m/s가 되는 것이 아니라 마지막으로 플레이어를 감지한 위치까지 빠른 속도를 유지한 뒤 약 <strong>2.7초</strong> 동안 감속합니다.<br>
• <strong>LOS:</strong> 일반적인 시야 지속에 따른 추가 가속을 사용하지 않습니다.</p>
        `
    },
    {
        name: "셰이드",
        ...
        tip: `<strong>1. 수줍음 & 낮은 사냥 정신력 메커니즘</strong><br>
              ...
              • <strong>동일 공간 활동 차단:</strong> 셰이드와 <strong>같은 방에 플레이어가 있으면 사냥과 고스트 이벤트가 불가능</strong>합니다. 단, 상호작용 범위가 다른 방에 걸쳐 있다면 해당 방의 물체와 상호작용할 수 있습니다.<br>
              • <strong>그림자 형체 선호:</strong> 고스트 이벤트 시 완전한 실체보다는 검은 그림자나 투명 형태로 나타날 확률이 높습니다.`,
        huntSanity: "35%",
        specialTrait: "사냥 정신력 35%, 같은 방 플레이어가 있으면 사냥이 불가능하며 상호작용도 제한됩니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>동일 공간 활동 차단 (Shy Ghost):</strong> 셰이드와 <strong>같은 방에 플레이어가 있으면 사냥과 고스트 이벤트를 시작하지 못합니다.</strong> 상호작용 범위가 다른 방에 걸쳐 있다면 그 방의 물체와 상호작용할 수 있습니다.<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>사냥 임계값:</strong> <strong>35%</strong>.<br>
• <strong>같은 방:</strong> 플레이어가 한 명이라도 같은 방에 있으면 상호작용, 유령 이벤트, 사냥을 수행할 수 없습니다.<br>
• <strong>이벤트:</strong> 안개 형태 이벤트 확률이 <strong>60%</strong>로 일반 20%보다 높습니다.<br>
• <strong>정신력과 이벤트:</strong> 평균 정신력 100%에서는 이벤트 성공 확률이 0%이며, 평균 정신력이 50%가 되면 시도한 이벤트가 항상 성공합니다.<br>
• <strong>주의:</strong> 유령의 상호작용 범위가 플레이어가 있는 방까지 닿는 경우, 같은 방에 직접 들어오지 않고도 물건을 건드릴 수 있습니다.</p>
        `
    },
    {
        name: "타예",
        ...
        tip: `<strong>1. 나이듦(Aging) 및 스펙 노화 메커니즘</strong><br>
              • <strong>나이듦 조건:</strong> 첫 Aging은 조사 구역의 출입문이 열린 뒤 약 1분 후 시도되며, 이후 플레이어가 같은 방 또는 약 3m 이내에 있을 때 1~2분 간격으로 나이를 먹습니다. 조건이 맞지 않으면 재시도합니다. <strong>총 10단계</strong>까지 노화합니다.<br>
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>총 10단계:</strong> 나이가 들수록 활동성, 사냥 임계값, 속도가 감소합니다.<br>
• <strong>최연소:</strong> 속도 <strong>2.75 m/s</strong>, 사냥 임계값 <strong>75%</strong>.<br>
• <strong>최고령:</strong> 속도 <strong>1.0 m/s</strong>, 사냥 임계값 <strong>15%</strong>.<br>
• <strong>첫 노화:</strong> 입구 문을 연 뒤 약 <strong>1분</strong> 후 노화를 시도하며, 이후 조건에 따라 약 1~2분 간격으로 노화합니다.<br>
• <strong>노화 조건:</strong> 유령과 같은 방 또는 약 <strong>3m 이내</strong>에 플레이어가 있으면 노화가 진행될 수 있습니다.</p>
        `
    },
    {
        name: "미믹",
        ...
        tip: `<strong>1. 유령 복제 & 가짜 고스트 오브 메커니즘</strong><br>
              • <strong>다른 유령 복제:</strong> 처음에는 약 60초 후 복제 대상을 정하고, 이후 약 30~120초 사이의 간격으로 다른 유령을 복제할 수 있습니다. 복제한 유령의 주요 행동과 사냥 특성을 따라갑니다.<br>
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
                • <strong>가짜 오브 테스트:</strong> 증거가 제한된 난이도에서도 고스트 오브가 보인다면 미믹을 강하게 의심할 수 있습니다. 단, 오브 하나만으로 다른 행동을 확인하지 않고 100% 확정하지는 않는 것이 좋습니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>변장:</strong> 다른 유령의 능력과 행동을 그대로 모방하며 조사 중 다른 유령으로 바뀔 수 있습니다.<br>
• <strong>변경 주기:</strong> 최초 변장은 약 <strong>60초</strong> 후 시작되며 이후 약 <strong>30~120초</strong> 사이에 변경될 수 있습니다.<br>
• <strong>고스트 오브:</strong> 실제 증거가 아닌 <strong>2차 증거</strong>로 항상 나타날 수 있으며, 0증거에서도 확인할 수 있습니다.<br>
• <strong>핵심:</strong> 레버넌트처럼 빨라졌다가 데오겐처럼 느려지는 등, 한 계약에서 여러 유령의 행동을 순차적으로 보여줄 수 있습니다.</p>
        `
    },
    {
        name: "트윈스",
        ...
        sanity: "50%",
        speed: "느린 사냥 1.5 m/s / 빠른 사냥 1.9 m/s (가속 O)",
        ytUrl: "https://www.youtube.com/results?search_query=파스모포비아+트윈스+공략",
        tip: `<strong>1. 본체/분신 이원화 & 사냥 속도 메커니즘</strong><br>
              • <strong>두 개의 상호작용 범위:</strong> 트윈스는 실제로 두 유령이 존재하는 것이 아니라, 하나의 유령이 서로 다른 두 개의 상호작용 범위를 사용하는 방식으로 두 장소에서 활동하는 것처럼 보입니다.<br>
              • <strong>본체 사냥 (1.5 m/s):</strong> 본체가 사냥을 시작하면 <strong>1.5 m/s로 약간 느리게</strong> 이동합니다.<br>
              • <strong>빠른 사냥 (1.9 m/s):</strong> 빠른 사냥이 발생하면 <strong>1.9 m/s</strong>로 이동합니다.`,
        huntSanity: "50%",
        specialTrait: "하나의 유령이 두 개의 상호작용 범위를 사용하며, 사냥 속도는 1.5m/s 또는 1.9m/s로 나타날 수 있습니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: true,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                • <strong>하나의 유령:</strong> 트윈스는 본체와 분신으로 나뉜 두 유령이 아니라, 하나의 유령이 두 개의 상호작용 범위를 사용하는 특수 유령입니다.<br>
                • <strong>본체 사냥 속도 (1.5 m/s):</strong> 본체가 사냥을 시작하면 일반 속도(1.7m/s)보다 약간 느린 <strong>1.5 m/s</strong>로 걸어다닙니다.<br>
                • <strong>빠른 사냥 속도 (1.9 m/s):</strong> 빠른 사냥이 발생하면 일반 속도보다 약간 빠른 <strong>1.9 m/s</strong>로 이동합니다.<br>
                • <strong>활동 그래프:</strong> 활동 그래프의 특정 모양만으로 트윈스를 확정할 수는 없습니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • EMF 5단계 (EMF Level 5)<br>
            ...
            <p class="dict-text">
                ...
                • <strong>약점 (Weakness):</strong> 느린 사냥과 빠른 사냥의 속도 차이를 관찰하면 판별에 도움이 됩니다.
            </p>
            <div class="dict-section-title">4. 공략 및 식별법 (Strategies)</div>
            <p class="dict-text">
                • <strong>발소리 속도 비교:</strong> 사냥마다 약 1.5m/s와 1.9m/s의 두 가지 속도 패턴이 관찰된다면 트윈스를 의심할 수 있습니다.
            </p>
        
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>실체:</strong> 게임 내부적으로는 두 유령이 아니라 <strong>하나의 유령</strong>이 두 개의 상호작용 범위를 사용하는 방식입니다.<br>
• <strong>일반 범위:</strong> 소형/중형 최대 약 <strong>2.12m</strong>, 대형 최대 약 <strong>4.24m</strong>.<br>
• <strong>대형 범위:</strong> 소형/중형 최대 약 <strong>8.48m</strong>, 대형 최대 약 <strong>16.97m</strong>.<br>
• <strong>동시 상호작용:</strong> 약 <strong>1~2초</strong> 안에 두 범위에서 연속으로 상호작용을 만들 수 있습니다.<br>
• <strong>사냥 속도:</strong> 느린 쪽 <strong>1.5 m/s</strong>, 빠른 쪽 <strong>1.9 m/s</strong>.</p>
        `
    },
    {
        name: "요괴",
        ...
        tip: `<strong>1. 음성 자극 사냥 & 좁은 감지 메커니즘</strong><br>
              • <strong>음성 대화 조기 사냥 (80%):</strong> 요괴와 <strong>같은 방</strong>에서 음성 대화를 하면 <strong>정신력 80% 이하</strong>부터 조기 사냥을 시작할 수 있습니다.<br>
        ...
        specialTrait: "같은 방 음성 대화 시 80% 사냥 조건이 적용될 수 있으며, 사냥 중 음성/전자기기 감지 범위는 2.5m입니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>사냥 중 감지 제한:</strong> 사냥 중 요괴의 음성 및 전자기기 감지 범위는 <strong>2.5m</strong>로 매우 짧습니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • 스피릿 박스 (Spirit Box)<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>사냥 임계값:</strong> 일반 50%, 같은 방에서 플레이어가 음성 채팅을 사용하면 일시적으로 <strong>80%</strong>까지 올라갈 수 있습니다.<br>
• <strong>사냥 중 감지:</strong> 음성과 활성 전자기기 감지 범위가 모두 <strong>2.5m</strong>로 크게 줄어듭니다.<br>
• <strong>실전 테스트:</strong> 사냥 중 가까이 접근했을 때만 전자기기/목소리에 반응하는지를 확인하면 요괴 판별에 도움이 됩니다.</p>
        `
    },
    {
        name: "유레이",
        ...
        huntSanity: "50%",
        specialTrait: "특수 문 닫기 능력으로 주변 플레이어의 정신력이 15% 감소하며, 정화향초 후 90초 동안 favourite room을 유지합니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: false,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <p class="dict-text">
                ...
                • <strong>정화향초 방 봉인:</strong> 유레이에게 정화향초를 사용하면 <strong>90초 동안 favourite room을 유지하는 특수 효과</strong>가 적용되어 로밍이 제한됩니다.
            </p>
            <div class="dict-section-title">2. 증거 (Evidence)</div>
            <p class="dict-text">
                • 고스트 오브 (Ghost Orb)<br>
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>문 닫기 능력:</strong> 현재 방에 열린 문이 있을 때 능력을 사용할 수 있으며, 주변 <strong>7.5m</strong> 이내 플레이어의 정신력을 <strong>15%</strong> 감소시킬 수 있습니다.<br>
• <strong>문 특징:</strong> 일반 상호작용과 달리 능력으로 닫는 문은 완전히 닫히며, 강하게 닫히는 소리 없이 부드럽게 닫힙니다. EMF 2가 발생합니다.<br>
• <strong>향초:</strong> 정화 후 <strong>90초</strong> 동안 로밍 상태가 선호 방 상태로 대체되어 유레이가 선호 방 밖으로 로밍하는 것을 막습니다.<br>
• <strong>DOTS:</strong> 이 90초 동안 DOTS 상태에도 들어갈 수 없습니다.</p>
        `
    },
    {
        name: "아스왕",
        ...
        tip: `<strong>1. 사냥 및 은신처 상호작용 메커니즘</strong><br>
              ...
              • <strong>공식 은신처 대응:</strong> 아스왕은 공식 은신처에 있는 플레이어를 사냥으로 직접 죽일 수 없습니다.<br>
              • <strong>은신처 활용:</strong> 아스왕의 속도 특성을 이용해 공식 은신처에서 안전하게 거리를 확보하는 것이 핵심입니다.`,
        huntSanity: "50%",
        specialTrait: "기본 속도 1.53 m/s에서 최고 2.53 m/s까지 가속하며, 공식 은신처의 플레이어를 직접 죽일 수 없습니다.",
        forcedEvidence: "없음",
        hasAccel: true,
        hasSpecialSpeed: true,
        hasForcedEv: false,
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>기본 속도:</strong> <strong>1.53 m/s</strong>.<br>
• <strong>시야 가속:</strong> 일반 유령의 0.05배/초보다 빠른 <strong>0.075배/초</strong>로 가속하여 약 <strong>8.67초</strong> 만에 최대 <strong>2.53 m/s</strong>에 도달합니다.<br>
• <strong>공식 은신처:</strong> 올바르게 사용한 공식 은신처 안의 플레이어를 감지하고 도달하면 사냥이 종료되며 플레이어를 죽일 수 없습니다.<br>
• <strong>다음 사냥:</strong> 이 방식으로 사냥이 끝나면 다음 사냥 시작 시 해당 플레이어 위치를 향한 웨이포인트를 생성할 수 있습니다.</p>
        `
    },
    {
        name: "코르모스",
        ...
        detailedHtml: `
            ...
            <div class="dict-section-title">5. 핵심 수치 & 판별 포인트</div>
<p class="dict-text">• <strong>기본 사냥 임계값:</strong> <strong>50%</strong>.<br>
• <strong>주변 플레이어가 같은 방에서 질주:</strong> 임계값이 <strong>70%</strong>로 상승합니다.<br>
• <strong>기본 속도:</strong> <strong>1.7 m/s</strong>. 5m 밖에서 플레이어의 움직임을 감지해 마지막 위치로 이동할 때 <strong>2.21 m/s</strong> 상태가 적용됩니다.<br>
• <strong>시야:</strong> 일반 유령처럼 플레이어를 시야로 추적하지 않으며, 움직임을 소리로 감지합니다.<br>
• <strong>이벤트:</strong> 안개 형태 및 추격 형태의 유령 이벤트를 수행하지 않습니다.</p>
        `
    }
];
